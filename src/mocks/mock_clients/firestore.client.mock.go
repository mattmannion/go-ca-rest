...
func NewFirestoreTestClient(ctx context.Context, projectID string, opts ...option.ClientOption) (*firestore.Client, error) {
	return firestore.NewClient(ctx, "test", opts[0])
}
